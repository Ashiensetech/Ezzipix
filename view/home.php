            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="table-layout animation" data-toggle="waypoints" data-showanim="fadeInRight" data-trigger-once="true">
                        <div class="col-xs-2 valign-top"><img src="<?php echo $this->baseUrl.'html_template/dist/image/icons/responsivewebdesign.png'; ?>" width="100%" alt=""></div>
                ...
                <div class="col-md-4">
                    <div class="table-layout animation" data-toggle="waypoints" data-showanim="fadeInRight" data-trigger-once="true">
                        <div class="col-xs-2 valign-top"><img src="<?php echo $this->baseUrl.'html_template/dist/image/icons/seoplanning.png';?>" width="100%" alt=""></div>
                ...
                <div class="col-md-4">
                    <div class="table-layout animation" data-toggle="waypoints" data-showanim="fadeInRight" data-trigger-once="true">
                        <div class="col-xs-2 valign-top"><img src="<?php echo $this->baseUrl.'html_template/dist/image/icons/branddevelopment.png';?>" width="100%" alt=""></div>
                        <div class="col-xs-10 pl15">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="table-layout animation mb0" data-toggle="waypoints" data-showanim="fadeInLeft" data-trigger-once="true">
                        <div class="col-xs-2 valign-top"><img src="<?php echo $this->baseUrl.'html_template/dist/image/icons/affiliatemarketing.png';?>" width="100%" alt=""></div>
                        <div class="col-xs-19 pl15">
                ...
                <div class="col-md-4">
                    <div class="table-layout animation mb0" data-toggle="waypoints" data-showanim="fadeInLeft" data-trigger-once="true">
                        <div class="col-xs-2 valign-top"><img src="<?php echo $this->baseUrl.'html_template/dist/image/icons/targetaudience.png';?>" width="100%" alt=""></div>
                        <div class="col-xs-10 pl15">
                ...
                <div class="col-md-4">
                    <div class="table-layout animation mb0" data-toggle="waypoints" data-showanim="fadeInLeft" data-trigger-once="true">
                        <div class="col-xs-2 valign-top"><img src="<?php echo $this->baseUrl.'html_template/dist/image/icons/customcoding.png';?>" width="100%" alt=""></div>
                        <div class="col-xs-10 pl15">
