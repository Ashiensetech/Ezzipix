                        ...
                        <form id="addServiceForm" action = "" onsubmit = "return false;" >
                            <table align = "center" class="table table-responsive">
                                ...
                                <tr id = "verification_code_send">
                                    <td>&nbsp;</td>
                                    <td><input id="getVerifucationBtn" type = "button" onclick = "sendCode();" value = "Get Verification Code" class="btn btn-success btn-block"/></td>
                                </tr>
                                <tr id = "verification_code_submit" style = "display: none">
                                    <td>&nbsp;</td>
                                    <td><input id="addServiceBtn" type = "button" onclick = "addService();" value = "Submit You Code" class="btn btn-success btn-block" /></td>
                                </tr>
