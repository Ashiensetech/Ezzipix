            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <div class="content data-profile site-border">
                        <form role="form" onsubmit="return addShipping();">
                        ...
                        <div class="form-group">
                            <input titleName="First Name" type="text" readonly class="form-control input-lg mendatory" id="first-name" value=<?php echo @$user['first_name'] ?>>
                        </div>
                        <div class="form-group">
                            <input titleName="Email" type="text" readonly class="form-control input-lg mendatory" id="email" value=<?php echo @$user['email'] ?>>
                        </div>
                        <div class="form-group clearfix clear">
                            <input titleName="Address 1" type="text" class="form-control input-lg mendatory" id="address1" placeholder="Address 1">
                        </div>
                        <div class="form-group clearfix clear">
                            <input titleName="Address 2" type="text" class="form-control input-lg" id="address2" placeholder="Address 2">
                        </div>
...
<!--                        </div>-->
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-success btn-block btn-lg">Add Shipping</button>
                        </div>
                    </div>
                </div>
            </div>
